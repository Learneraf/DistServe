...
SEED_PROFILE="${SEED_PROFILE:-/users/rh/DistServe/simdistserve/estimators/profiled_data/distserve-cuda/fit_params_live_cuda_data.json}"
WORKLOAD_ROOT="${WORKLOAD_ROOT:-/users/rh/DistServe/simdistserve/dataset/splits/sharegpt_four_models_common_ascend1900_seed0}"
REAL_FIT_ROOT="${REAL_FIT_ROOT:-/users/rh/DistServe/evaluation/2-benchmark-serving/result_split/fit}"
REAL_VALID_ROOT="${REAL_VALID_ROOT:-/users/rh/DistServe/evaluation/2-benchmark-serving/result_split/val}"
PROFILE_FINAL="${PROFILE_FINAL:-/users/rh/DistServe/simdistserve/estimators/profiled_data/distserve-cuda/fit_params_split_component.json}"
FIT_WORK_DIR="${FIT_WORK_DIR:-/users/rh/DistServe/simdistserve/benchmarks/results/fit_work/distserve_cuda_split_component}"
VALIDATION_ROOT="${VALIDATION_ROOT:-/users/rh/DistServe/simdistserve/benchmarks/results/validation/distserve_cuda_split_component}"
...
echo "CUDA split-component refit and validation completed."
