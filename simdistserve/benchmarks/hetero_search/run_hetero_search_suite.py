...
from simdistserve.benchmarks.hetero_search.search_hetero import (
    _config_to_dict,
...
def main() -> None:
    args = parse_args()
    os.environ["SIMDISTSERVE_DISTSERVE_PROFILE"] = str(args.cuda_profile)
    os.environ["SIMDISTSERVE_VLLM_ASCEND_PROFILE"] = str(args.ascend_profile)
