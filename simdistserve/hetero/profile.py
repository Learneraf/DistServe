...
class SimulationGoodputProfiler:
    ...
    def _cache_key(self, shape: RoleShape) -> str:
        payload: dict[str, Any] = {
            ...
            "ttft_target_ms": self.prefill_target_ms,
            "tpot_target_ms": self.decode_target_ms,
            "ttft_attainment": self.prefill_attainment,
            "tpot_attainment": self.decode_attainment,
    ...
    def _meets_slo(self, shape: RoleShape, rate: float) -> bool:
        ...
        args = [
            ...
            "--ttft-containment", str(self.prefill_attainment),
            "--ttft-target", str(int(prefill_target)),
            "--tpot-containment", str(self.decode_attainment),
            "--tpot-target", str(int(decode_target)),
            "--slas", "[]",
            "--slo-scales", "[1]",
            "--handoff-delay-ms", "0",
